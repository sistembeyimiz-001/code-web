...
if single item in container can stretch on main axis using `flex: 1` as replacement for `justify-self/items: stretch`
SHOULD HAVE ALIGNED THE FLEX LINE ALONG THE MAIN AXIS???
...
<!-- ToDo: integrate in Alignment, unite with Grid version -->
