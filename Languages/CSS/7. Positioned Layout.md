...
- beware: "`static` location" of absolutely / fixedly positioned element in Flex Layout is as it were the sole flex item in the flex container ❗️
...
- for flex item is content box of parent
- for grid item is grid area it's placed in
