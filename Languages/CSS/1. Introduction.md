...
- use semantic elements with styles, instead of non-semantic one with classes, defies separation of content and styling since must add class for every element, "classitis" is overuse of classes to style everything
